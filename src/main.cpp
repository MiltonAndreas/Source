...
int64 nChainStartTime = 1399901970;
...
const string strMessageMagic = "rightcoin Signed Message:\n";
...
static const int CUTOFF_HEIGHT = POW_CUTOFF_HEIGHT;	// Height at the end of 5 days
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in rightcoin
    bool fStrictPayToScriptHash = true; // Always active in rightcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "rightcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
      if (!fAllowNew)
        ...
        // Genesis block
        const char* pszTimestamp = "Dont buy wrong coin, Buy rightcoin 2/May/2014";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x20b074255f80945acd6436b84f07ed91c3542bcb59ff6dd037b1233fdff5a980"));
